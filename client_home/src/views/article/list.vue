...
<script>
    ...
    import weather_widget from "@/components/diy/weather_widget.vue";
    import history_widget from "@/components/diy/history_widget.vue";
    import poetry_widget from "@/components/diy/poetry_widget.vue";
