...
const routes = [
	...
	// 自习室管理员路由
	{
		path: '/study_room_administrator/table',
		name: 'study_room_administrator_table',
		component: () => import('../views/study_room_administrator/table.vue')
	},
	{
		path: '/study_room_administrator/view',
		name: 'study_room_administrator_view',
		component: () => import('../views/study_room_administrator/view.vue')
	},
	// 自习室信息路由
	{
		path: '/study_room_information/table',
		name: 'study_room_information_table',
		component: () => import('../views/study_room_information/table.vue')
	},
	{
		path: '/study_room_information/view',
		name: 'study_room_information_view',
		component: () => import('../views/study_room_information/view.vue')
	},
	// 预约信息路由
	{
	...
	// 信誉值路由
	{
		path: '/reputation_value/table',
		name: 'reputation_value_table',
		component: () => import('../views/reputation_value/table.vue')
	},
	{
		path: '/reputation_value/view',
		name: 'reputation_value_view',
		component: () => import('../views/reputation_value/view.vue')
	},
	// 签到信息路由
	{
	...
	// 使用座位信息路由
	{
		path: '/use_seat_information/table',
		name: 'use_seat_information_table',
		component: () => import('../views/use_seat_information/table.vue')
	},
	{
		path: '/use_seat_information/view',
		name: 'use_seat_information_view',
		component: () => import('../views/use_seat_information/view.vue')
	},
...
router.afterEach((to, from, next) => {
	let title = "郑州轻工业大学自习室预约管理系统-admin";
